...
class App : RComponent<AppProps, AppState>() {
    ...
    fun Lessondelete() :(Event) -> Unit = {
        val onDelete = document.getElementById("Lessons") as HTMLInputElement
        val editedLessons = state.lessons.toMutableList().apply {
            removeAt(onDelete.value.toInt()-1) }
    ...
    fun Studentdelete() :(Event) -> Unit = {
        val onDelete = document.getElementById("Students") as HTMLInputElement
